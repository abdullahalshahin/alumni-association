$(document).ready(function() {
	...
	$("#products-datatable").DataTable({
		language: {
			...
			info: "Showing batches _START_ to _END_ of _TOTAL_",
			lengthMenu: 'Display <select class=\'form-select form-select-sm ms-1 me-1\'><option value="10">10</option><option value="20">20</option><option value="-1">All</option></select> batches'
		},
		pageLength: 10,
		columns: [{
			orderable: !1,
